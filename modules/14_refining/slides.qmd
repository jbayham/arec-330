...
## From Making Charts to Refining Charts
...
ggplot() +
  ...
  geom_line(data = received, aes(x = month_num, y = tickets), color = "gray45", linewidth = 1.5) +
  geom_line(data = resolved, aes(x = month_num, y = tickets), color = accent, linewidth = 1.9) +
  geom_point(data = received[8, ], aes(x = month_num, y = tickets), color = "gray35", size = 3) +
  geom_point(data = resolved[8, ], aes(x = month_num, y = tickets), color = accent, size = 3.4) +
  annotate("segment", x = 8.1, xend = 8.1, y = 118, yend = 149, color = alert, linewidth = 1.1) +
  annotate("text", x = 8.35, y = 149, label = "Received", hjust = 0, color = "gray30", size = 4) +
