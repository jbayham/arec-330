---
title: "Data Processing <br>Part 1"
format: 
  revealjs:
...
:::{.notes}
I want the students to discuss the data that we obtained. Most will probably say that the state level is good enough. Probe them on whether county is better. Even if they say state, the temporal data requires some aggregation.
:::
...
:::{.notes}
Recommend a short processing log for reproducibility: (1) a script that implements steps, (2) a README summarizing key decisions and rationale, (3) a small table listing transformations (what/why/how), and (4) brief results from sensitivity checks showing how conclusions change under alternate rules.
:::
...
## Bonus: Common Processing Mistakes{.scrollable}
