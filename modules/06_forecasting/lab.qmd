...
* $S_t$: seasonal component (repeats each year)
...
This matches the approach used in the text for decomposition-based forecasting examples. 
...
- In plain language: how good were the forecasts over the last 24 months? 
