...
You could also color by `farm_gdp` instead.
...
1. **Log file (`lab_13.log`)**
   Use the sink-source-sink pattern. Your log should include code, output, and brief comments.

2. **Lab notebook** with answers to Questions 1-8

3. **Screenshots or exports** of:
   - your Power BI report page with the map, scatterplot, and slicer
