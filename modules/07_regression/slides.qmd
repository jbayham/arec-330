...
::: {.column width="50%"}
Ommitting a variable correlated with both the independent and the dependent variable can **biased estimates** of the regression coefficients.
:::
...
This removes constant differences like:
