...
- The regression model relies on the assumption that the error terms ($\epsilon$) are independent and identically distributed (iid).
- This means that the errors are uncorrelated with each other.
- Is this assumption likely to hold in our corn and drought data? Why or why not?





<!-- Lead into fixed effects and panel data regression in the next lecture. -->