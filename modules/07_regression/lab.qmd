...
Draw axes on the board or screen:

- x-axis: drought severity (for example, DSCI)
- y-axis: corn yield (bu/acre)
...
:::{.callout-attention}
Question 1 (5%): Write a few sentences about your hypothesis in your notebook before running any models.
:::
...
Data source used in prior labs:
...
:::{.callout-attention}
**Question 4 (15%):** Does your QQ plot suggest that residuals are approximately normal? 
:::
...
- Is annual mean DSCI across the whole year the most relevant drought measure for corn yield?
- Propose an alternative measure and justify it.
